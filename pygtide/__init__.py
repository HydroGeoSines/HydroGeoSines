...
import pygtide.etpred
import os
from pathlib import Path

standard_wg = np.asarray([[0, 0.000001, 1., 0.],[0.000001, 0.000145, 1., 0.],[0.000146, 0.003426, 1., 0.],[0.004709, 0.010952, 1., 0.],[0.025811, 0.031745, 1., 0.],
    [0.033406, 0.044653, 1., 0.],[0.060131, 0.068640, 1., 0.],[0.069845, 0.080798, 1., 0.],[0.096422, 0.104932, 1., 0.],[0.106136, 0.115412, 1., 0.],
    [0.130192, 0.143814, 1., 0.],[0.145166, 0.249952, 1., 0.],[0.721499, 0.833113, 1., 0.],[0.851181, 0.859691, 1., 0.],[0.860895, 0.870024, 1., 0.],
    [0.887326, 0.896130, 1., 0.],[0.897806, 0.906316, 1., 0.],[0.921940, 0.930450, 1., 0.],[0.931963, 0.940488, 1., 0.],[0.958085, 0.966757, 1., 0.],
    [0.968564, 0.974189, 1., 0.],[0.989048, 0.998029, 1., 0.],[0.999852, 1.013690, 1., 0.],[1.028549, 1.034468, 1., 0.],[1.036291, 1.044801, 1., 0.],
    [1.064840, 1.071084, 1., 0.],[1.072582, 1.080945, 1., 0.],[1.099160, 1.216398, 1., 0.],[1.719380, 1.837970, 1., 0.],[1.853919, 1.872143, 1., 0.],
    [1.888386, 1.906463, 1., 0.],[1.923765, 1.942754, 1., 0.],[1.958232, 1.963709, 1., 0.],[1.965826, 1.976927, 1., 0.],[1.991786, 2.000767, 1., 0.],
    [2.002590, 2.013690, 1., 0.],[2.031287, 2.047391, 1., 0.],[2.067578, 2.182844, 1., 0.],[2.753243, 3.081255, 1., 0.],[3.381379, 4.347615, 1., 0.],
    [4.347616, 7.000000, 1., 0.],[7, 100, 1., 0.]])
...
class pygtide(object):
    ...
    def predict(self, latitude, longitude, height, startdate, duration, samprate, **control):
        ...
        if (enddate > (self.etddt_end + dt.timedelta(days=365))):
            ...
            if (self.msg): print("Warning: Prediction timeframe exceeds the end of the available time database (%s) plus 1 year. " \
                  "For best accuracy, please consider using the update script to check the accuracy of '%s'." % (self.etddt_end, file))
    ...
    def set_wavegroup(self, wavedata=standard_wg):
        ...
        etpred.waves(wavedata[:, 0], wavedata[:, 1], wavedata[:, 2], wavedata[:, 3])
        return True
        
    #%% reset the wave group
    def reset_wavegroup(self):
        etpred.waves(0, 100, 1, 0, 1)
        
    #%% easy access to the raw data calculated by the Fortran module
    def results(self, digits=-1):
        """
